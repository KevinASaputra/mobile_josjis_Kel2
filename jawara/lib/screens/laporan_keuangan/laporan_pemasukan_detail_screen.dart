...
class LaporanPemasukanDetailScreen extends StatelessWidget {
  final Map<String, dynamic> data;
  const LaporanPemasukanDetailScreen({super.key, required this.data});
  ...
  Widget build(BuildContext context) {
    ...
    final jumlah = data['nominal'] != null
        ...
        : '-';
    final verifikator = data['verifikator']?.toString() ?? '-';
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildDetailRow('Nama Pemasukan', nama),
